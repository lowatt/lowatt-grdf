...
*These endpoints return an 400 Client Error with Staging API v6 at this moment.*
...
1. Cas passant : Consulter mes droits d'accès avec filtre sur l'Etat "Obsolète"
   ```shell
   # Returns an 400 Client Error with Staging API v6 at this moment.
...
1. Cas passant : MM Données informatives
   ```shell
   # Doesn't work with PCE GI999947 as documentation says it should, but works with GI151947
